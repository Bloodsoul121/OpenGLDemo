...
public class Triangle {
    ...
    public Triangle() {
        ...
        //数据转换
        int vertexShader = GraphUtil.loadShader(GLES20.GL_VERTEX_SHADER, vertexShaderCode);
        int fragmentShader = GraphUtil.loadShader(GLES20.GL_FRAGMENT_SHADER, fragmentShaderCode);
